<template>
  <div>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 119 105">
      <rect width="119" height="105" fill="currentColor" filter="invert(100%)" rx="6" />
      <rect width="28" height="4" x="11" y="14" fill="currentColor" filter="invert(100%)" rx="2" />
